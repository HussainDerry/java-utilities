...
import com.github.hussainderry.crypto.enums.DigestType;
...
public final class PrefSecurityConfig implements Serializable {
     ...
     * */
    public PrefSecurityConfig(char[] password, int aesKeySize, int iPBKDF2Iterations, int saltSize, DigestType digestType) {
    ...
    public static class Builder{
        ...
        public PrefSecurityConfig build(){
            ...
            return new PrefSecurityConfig(password, finalKeySize, finalIterations, finalSaltSize, finalDigest);
        }
    }
}
